...
OPCODES = {
	...
	"ENCRETN": OpCode(59, IT_N, "ENCRETN"),
	# Integer Arithmetic 64bit
	"ADD64": OpCode(60, IT_RRVV64, "ADD64"),
	"SUB64": OpCode(61, IT_RRVV64, "SUB64"),
	"MUL64": OpCode(62, IT_RRVV64, "MUL64"),
	"DIV64": OpCode(63, IT_RRVV64, "DIV64"),
	"MOD64": OpCode(64, IT_RRVV64, "MOD64"),
	"SHL64": OpCode(65, IT_RRVV64, "SHL64"),
	"LSHR64": OpCode(66, IT_RRVV64, "LSHR64"),
	"ASHR64": OpCode(67, IT_RRVV64, "ASHR64"),
	"MULU64": OpCode(68, IT_RRVV64, "MULU64"),
	"DIVU64": OpCode(69, IT_RRVV64, "DIVU64"),
	# Float Arithmetic 32bit
	"ADDF": OpCode(70, IT_RRVV, "ADDF"),
	"SUBF": OpCode(71, IT_RRVV, "SUBF"),
	"MULF": OpCode(72, IT_RRVV, "MULF"),
	"DIVF": OpCode(73, IT_RRVV, "DIVF"),
	# Float Arithmetic 64bit
	"ADD64F": OpCode(74, IT_RRVV, "ADD64F"),
	"SUB64F": OpCode(75, IT_RRVV, "SUB64F"),
	"MUL64F": OpCode(76, IT_RRVV, "MUL64F"),
	...
	"OSOFF1": OpCode(85, IT_V8, "OSOFF1"),
	"OSOFF2": OpCode(86, IT_V8, "OSOFF2"),
	"OSOFF12": OpCode(87, IT_V8V8, "OSOFF12"),
