...
OPCODES = {
	...
	"HALT": OpCode(132, IT_N, "HALT"),
	"RESET": OpCode(133, IT_N, "RESET"),
	"TRAP": OpCode(134, IT_N, "TRAP"),
	"ENCOFF": OpCode(135, IT_N, "ENCOFF"),
	"ENCON": OpCode(136, IT_N, "ENCON"),
	"PUSHREG": OpCode(137, IT_N, "PUSHREG"),
	"POPREG": OpCode(138, IT_N, "POPREG"),
	"DEBUG": OpCode(139, IT_N, "DEBUG"),
	"RETNAC": OpCode(192, IT_U8, "RETNAC"),
	# Virtual
